...
<body>
 ...
 <div align ="center" >         
     <a href="add8.php"><h1>click here to add new photo</h1></a>
                        ...
                        <table border="1">
							...
							<?php
								require_once('db.php');
								$result = $conn->prepare("SELECT * FROM teachers ORDER BY id ASC");
								$result->execute();
							...
							?>
								...
								<td style="text-align:center; margin-top:10px; word-break:break-all; width:450px; line-height:100px;">
									...
									<?php else: ?>
									<img src="images/default.png" width="500px" height="510px" style="border:1px solid #333333;">
									                 <?php endif; ?>
